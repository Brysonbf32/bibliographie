...
<html dir="ltr" lang="en">
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
            <?php
            $admin=current($my_bd->query("SELECT COUNT(*) FROM utilisateur WHERE role_utilis='administrateur'")->fetch());
            $formateur=current($my_bd->query("SELECT COUNT(*) FROM utilisateur WHERE role_utilis='encadreur'")->fetch());
            ?>
            <div class="col-md-6 col-lg-6 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">Nombre Administrateur</h6>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-info  text-center">
                  ...
                  <h6 class="text-white">Nombre Formateur</h6>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-body">
                   ...
                   <p> <button type="button" class="btn btn-secondary btn-sm add_itemsrh" data-bs-toggle="modal" data-bs-target="#adduser" data-bs-whatever="@mdo">Ajouter</button>  <span class="add_itemsrh_textdroite" align="right">Tout Les Utilisateurs</span>
                  </p>
                  </div>
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th class="th_table" scope="col">Nom </th>
                          <th class="th_table" scope="col">Mot de passe</th>
                          <th class="th_table" scope="col">E-mail</th>
                          <th class="th_table" scope="col">Role</th>
                          <th class="th_table" scope="col">Action</th>
                        </tr>
                      </thead>
                      <?php
                      $recupedata=$my_bd->query("SELECT * FROM utilisateur ORDER BY id_utilis DESC");
                      if($recupedata->rowCount()>0){
                        while($checkdata=$recupedata->fetch()){
                            $iduse=$checkdata['id_utilis'];
                            $nomutilisa=$checkdata['Nom_utilis'];
                            $motpass=$checkdata['Password_utilis'];
                            $email=$checkdata['Email_utilis'];
                            $images=$checkdata['img_util'];
                            $roleu=$checkdata['role_utilis'];
                      ?>
                      <tbody id="searchosx">
                        <tr>
                          <td class="td_table "><img src="image/<?=$images?>" class="img-fluid" width="50px" height="50px"></td>
                          <td class="td_table"><?=$nomutilisa;?></td>
                          <td class="td_table"><?=$nomutilisa;?></td>
                          <td class="td_table"><?=$motpass;?></td>
                          <td class="td_table"><?=$email?></td>
                          <td class="td_table"><?=$roleu?></td>
                          <td><button type="button" class="btn btn-secondary btn-sm edit_itemsrh" data-bs-toggle="modal" data-bs-target="#modif<?=$iduse?>">Edit</button> &nbsp;
                          <button type="button" class="btn btn-primary btn-sm delete_itemsrs" data-bs-toggle="modal" data-bs-target="#suprim<?=$iduse?>">Supprimer</button></td>
                        </tr>
                      </tbody>
                                ...
                                <div class="modal-body">
                                      <form method="POST">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <input type="text" class="modal_input" name="input_password" value="<?=$motpass?>">
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <label for="recipient-name" class="modal_labeltext">E-mail:</label>
                                            <input type="text" class="modal_input" name="input_mail" value="<?=$email?>">
                                        </div>
                                        <div class="col-12 col-lg-6">
  ...
  <div class="modal fade" id="adduser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header modal_foterbar footbar">
            <h5 class="modal_labeltext" id="exampleModalLabel">Ajouter Utilisateur</h5>
            <button type="button" class="btn-close btn_modalclose" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
              <div class="modal-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12 col-lg-12">
                      <label for="recipient-name" class="modal_labeltext">Photo Utilisateur:</label>
                      <input type="file" class="modal_input" name="input_image">
                  </div>
                  <div class="col-12 col-lg-6">
                      <label for="recipient-name" class="modal_labeltext">Nom Utilisateur:</label>
                      <input type="text" class="modal_input" name="input_nonutili">
                  </div>
                  <div class="col-12 col-lg-6">
                      <label for="recipient-name" class="modal_labeltext">Mot de passe:</label>
