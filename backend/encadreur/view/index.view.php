  ...
  <body>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="row">
          <?php
            $etudiant=current($my_bd->query("SELECT COUNT(*) FROM tbl_etudiant")->fetch());
            $projets=current($my_bd->query("SELECT COUNT(*) FROM tbl_projets")->fetch());
            $publication=current($my_bd->query("SELECT COUNT(*) FROM tbl_stagiaire_projet")->fetch());
          ?>
