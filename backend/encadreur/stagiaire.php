...
if(isset($_POST['ajouter'])){
    ...
    if(isset($nomstag) and !empty($domaine) and !empty($datanaista) and !empty($mailsta) and !empty($matricule) and !empty($unive) and !empty($sexe)){
        ...
        if($checkdata >0){
            ...
            $insert_sta->execute(array($domaine,$nomstag,$datanaista,$mailsta,$matricule,$unive,$file_name,$sexe));
        }
    }
}
    }
...
if(isset($_POST['modifier'])){
    ...
    if(isset($idstag)){
        ...
        if($checks >0){
            ...
            $update_sta->execute(array($domaine,$nomstag,$datanaista,$mailsta,$matricule,$unive,$file_name,$sexe));
        }
    }
    }
}
